...
def main():
    ...
    if st.button("Generate SQL Query"):
        ...
        sql_response = requests.post(
            f"{API_BASE_URL}/query/{selected_db_id}/generate_sql", params={"text_query": query_text}
        )
        ...
        query_result_response = requests.post(
            f"{API_BASE_URL}/query/{selected_db_id}/execute_sql", params={"sql_query": sql_query}
        )
